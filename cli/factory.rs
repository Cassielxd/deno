...
use deno_runtime_tauri::deno_node::DenoFsNodeResolverEnv;
...
impl CliFactory {
    ...
    pub async fn create_cli_main_worker_factory_tauri(&self, fake_http_recever: Option<HttpReceiver>) -> Result<CliMainWorkerFactory, AnyError> {
        let cli_options = self.cli_options()?;
        ...
        Ok(CliMainWorkerFactory::new(
            ...
            self.create_cli_main_worker_options_tauri(fake_http_recever)?,
    ...
    fn create_cli_main_worker_options_tauri(
        &self, fake_http_recever: Option<HttpReceiver>,
